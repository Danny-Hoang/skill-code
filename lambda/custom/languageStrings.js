...
module.exports = {
    en: {
        translation: {
            GO_HOME_MSG:'go home',
            SESSION_END_MSG:'session ended',
            TURN_ON_MSG:'device is turning on',
            TURN_OFF_MSG:'device is turning off',
            CHANNEL_DOWN_MSG:'channel down',
            CHANNEL_UP_MSG:'channel up',
            VOLUME_UP_MSG:'volume up',
            VOLUME_DOWN_MSG:'volume down',
            VOLUME_MUTE_MSG:'volume off',
            GO_TO_CHANNEL_MSG:'Openning channel {{channelName}}',
            GO_TO_CHANNEL_NUMBER_MSG:'Openning channel {{channelNumber}}',
            SEARCH_CONTENT_MSG:'Searching {{searchString}}',
            OPEN_APPLICATION_MSG:'Openning {{appName}}',
            WELCOME_MSG: 'Welcome to device control, what would you like to do?',
